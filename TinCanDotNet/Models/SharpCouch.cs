// Based on SharpCouch - a simple wrapper class for the CouchDB HTTP API
...
namespace TinCanDotNet.Models
{
	...
	public class DB
	{
		...
		*/
		...
		public string CreateDocument(string server,string db,string content)
		{
			return DoRequest(server+"/"+db,"POST",content,"application/json");
		}
